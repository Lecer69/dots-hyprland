...
hl.window_rule({match = {title = "^(File Already Exists — Ark)(.*)$" },       float = true})
hl.window_rule({match = {title = "^(File Already Exists — Ark)(.*)$" },       size = {"(monitor_w*0.35)", "(monitor_h*0.40)"}})
hl.window_rule({match = {title = "^(File Already Exists — Ark)(.*)$" },       center = true})
