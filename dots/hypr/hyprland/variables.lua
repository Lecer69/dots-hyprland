...
secondaryBrowser = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'brave-origin' 'brave' 'zen-browser' 'google-chrome-stable' 'firefox' 'chromium' 'microsoft-edge-stable' 'opera' 'librewolf'"
