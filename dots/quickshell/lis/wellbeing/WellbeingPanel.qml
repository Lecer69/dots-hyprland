...
Rectangle {
    ...
    property int currentMax: currentList.length > 0 ? currentList[0].secs : 1
    property int totalSecs: {
        var s = 0;
    ...
    function _enrich(arr) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            out.push({
                ...
                "secs": item.secs,
                "color": stat.color,
                "timeLabel": state.formatTime(item.secs),
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Text {
                // Guard: only call formatTime once state is loaded
                text: state._loaded ? (state.formatTime(root.totalSecs) + " total") : ""
                color: "#3a3a3a"
                font.pixelSize: 11
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        WellbeingBar {
                            ...
                            seconds: modelData.secs
                            maxSeconds: root.currentMax
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    text: (state._loaded && state.activeApp !== "") ? state.formatTime(state.currentSessionSecs) : ""
