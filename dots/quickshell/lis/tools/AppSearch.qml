...
Singleton {
    ...
    function guessIcon(str) {
        ...
        // hardcoded fixes
        if (str === "v2rayN" || str === "v2rayN-bin" || str === "xray")
            return DesktopEntries.byId("v2rayN-bin").icon

        if (str?.toLowerCase().includes("osu"))
            return DesktopEntries.byId("osu-lazer").icon
